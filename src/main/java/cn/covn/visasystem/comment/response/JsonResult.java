package cn.covn.visasystem.comment.response;
...
//    }
    ...
    public JsonResult(StatusCode statusCode,String msg, Object data) {
        this.code = statusCode.getCode();
        this.msg = msg;
        this.data = data;
    }
    ...
    public static JsonResult ok(String msg,Object data){
        return new JsonResult(StatusCode.OPERATION_SUCCESS,msg, data);
    }
